 ...
 */
const { button, card, input, searchBar, actionCard, contentCard, dashboard, searchInterface, contentManager, enhancedSearch, campaignSelector, create: create$2 } = platform;
...
const createButton = vanillaPlatform.button;
const createCard = vanillaPlatform.card;
const createInput = vanillaPlatform.input;
const createSearchBar = vanillaPlatform.searchBar;
const createActionCard = vanillaPlatform.actionCard;
const createContentCard = vanillaPlatform.contentCard;
const createDashboard = vanillaPlatform.dashboard;
const createSearchInterface = vanillaPlatform.searchInterface;
const createContentManager = vanillaPlatform.contentManager;
const createEnhancedSearch = vanillaPlatform.enhancedSearch;
const createCampaignSelector = vanillaPlatform.campaignSelector;
// Export generic factory
const create$1 = vanillaPlatform.create;
...
var index$3 = /*#__PURE__*/Object.freeze({
    ...
    createCampaignSelector: createCampaignSelector,
    createCard: createCard,
    createContentCard: createContentCard,
    createContentManager: createContentManager,
    createDashboard: createDashboard,
    createEnhancedSearch: createEnhancedSearch,
    createInput: createInput,
    createSearchBar: createSearchBar,
    createSearchInterface: createSearchInterface,
